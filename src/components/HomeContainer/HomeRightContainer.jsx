...
const HomeRightContainer = () => {
  ...
  return (
    <div className="dark:bg-gray-700 bg-white rounded-lg p-4 transition-all duration-300 ease-in-out">
      <div className={`border border-gray-200 p-2 rounded-md space-y-3 transition-all duration-600 ease-in-out`}>
        <div
        ...
        <div className={`transition-all duration-300 ease-in-out space-y-3 ${open ? "opacity-0 max-h-0 " : " opacity-100 max-h-full "}`}>
