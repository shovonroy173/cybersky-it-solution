...
const SearchSettings = () => {
  ...
  return (
    <div >
        ...
        <div className={`transition-all duration-300 ease-in-out space-y-3 dark:bg-gray-700 bg-white mt-3 rounded-md ${open ? "opacity-100 max-h-full" : "opacity-0 max-h-0"}`}>
        <HomeLeftContainer/>
        <hr />
        <HomeRightContainer/>
        </div>
